  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-60">
        <div className="w-full max-w-4xl mx-auto px-4 sm:px-10 py-8 md:py-14 mt-20">
          ...
          <div className={`text-center mb-8 transition-all duration-1000 ease-out transform 
            ...
            <div className="h-6 relative mb-0">
              <div className="flex items-center justify-center gap-2 text-white">
                ...
                <span className="text-sm sm:text-base md:text-lg min-h-[24px] inline-flex items-center">
                  {displayText}
